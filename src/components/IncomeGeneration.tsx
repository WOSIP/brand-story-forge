  ...
  const revenueSources = [
    {
      ...
      works: "A small percentage (e.g., 1% on Standard package) on every payment, transfer, or loan repayment processed through the community.",
      who: "Merchants and/or users",
      icon: <TrendingUp className="w-5 h-5 text-primary" />
    },
    {
      title: "Setup & Annual Fees",
      works: "Fees paid by the association to Helloopass ($5,000 setup + $5,000 annual). The association then determines how to recover this cost.",
      ...
      <section className="relative h-[60vh] flex items-center overflow-hidden mb-20">
        ...
        <div className="container mx-auto px-6 relative z-10">
          <motion.div 
            ...
            className="max-w-3xl"
          >
            <Badge className="mb-4 bg-primary/20 text-primary border-primary/20 backdrop-blur-md px-4 py-1">
            ...
            <p className="text-xl text-white/90 leading-relaxed font-medium">
              The association does not just serve the community. It earns from the community's activity and reinvests that income back into the community.
            </p>
          </motion.div>
        </div>
      </section>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <motion.div {...fadeInUp}>
              ...
              <p className="text-lg text-muted-foreground leading-relaxed mb-8">
                This creates a <span className="text-primary font-bold italic">virtuous cycle</span> where the more the community uses Helloopass, the more the association earns, and the more it can give back to its members.
              </p>
              <div className="space-y-4">
                ...
                <div className="flex gap-4 items-start bg-card p-6 rounded-2xl border border-border shadow-sm">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">Wealth is retained within the community rather than extracted by outside banks.</p>
                  </div>
                </div>
              </div>
            </motion.div>
            ...
            <motion.div 
              {...fadeInUp}
              className="relative p-8 bg-primary/5 rounded-[2rem] border-2 border-primary/10"
            >
              ...
              <div className="flex flex-col items-center gap-6">
                {[
                  ...
                  <React.Fragment key={idx}>
                    <div className={`w-full p-4 bg-white rounded-xl border border-${item.color}/20 text-center shadow-sm relative group hover:scale-105 transition-transform`}>
              ...
              <Card key={idx} className="border-border hover:border-primary/50 transition-colors bg-card shadow-sm group">
                ...
                <CardContent>
                  ...
                  <div className="pt-4 border-t border-border flex items-center justify-between">
                    ...
                    <Badge variant="outline" className="text-[10px]">{source.who}</Badge>
                  </div>
                </CardContent>
              </Card>
            ))}
          ...
          <div className="bg-foreground text-background rounded-[3rem] p-12 md:p-20 overflow-hidden relative">
            ...
            <motion.div {...fadeInUp} className="relative z-10">
              ...
              <p className="text-background/70 text-center max-w-2xl mx-auto mb-16">
                The association does not keep all the income. A portion is reinvested to benefit all members through various strategic methods.
              </p>
          ...
          <div className="max-w-4xl mx-auto text-center">
            ...
            <div className="bg-primary p-12 rounded-[2rem] text-primary-foreground shadow-2xl shadow-primary/30">
              <p className="text-2xl md:text-3xl font-black leading-tight">
                The association earns sustainable income from community transactions and reinvests that income directly into member benefits – funding its own growth and prosperity.
              </p>
              <Separator className="my-8 bg-white/20" />
              <p className="font-black tracking-widest uppercase text-sm opacity-80">Helloopass – Empowering Communities Through Digital Trade</p>
            </div>
          </div>
        </section>
      </div>
...
const X = ({ className }: { className?: string }) => (
  <svg className={className} xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="3" strokeLinecap="round" strokeLinejoin="round"><path d="M18 6 6 18"/><path d="m6 6 12 12"/></svg>
);
