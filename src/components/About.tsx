        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          >
            ...
            <p className="text-lg text-muted-foreground mb-8 leading-relaxed">
              HellOOpass is a digital platform that helps <strong>cooperatives, unions, and associations</strong> turn their member
              communities into self-sufficient digital economies. Think of it like this:{" "}
              <strong>Visa empowers banks. HellOOpass empowers you.</strong>
            </p>
